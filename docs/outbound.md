...
|---|---|---|
| Plan Approval | Plan text + optional model/agent label | Approve, Run, Epic, Reject, Feedback |
...
The plan **Run** button approves the plan with `commit_plan: false` and `run_coder: true`, which starts coder work
